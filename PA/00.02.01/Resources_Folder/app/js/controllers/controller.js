(function() {
  ...
  $OpsiUserFilters = function(appData, translationData, $scope) {
  ...
  $OpsiUserTiles = function(appData, translationData, $fum, $interpolate, $scope, $http, $window, $q) {
  ...
  app.controller('OpsiUserFilters', ['appData', 'translationData', '$scope', $OpsiUserFilters]);

  app.controller('OpsiUserTiles', ['appData', 'translationData', '$fum', '$interpolate', '$scope', '$http', '$window', '$q', $OpsiUserTiles]);
