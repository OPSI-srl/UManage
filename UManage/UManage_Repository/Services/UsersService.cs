...
namespace UManage_Repository.Services
{
    public class UsersService
    {
            ...
            )
        {
            ...
            //try
            //{
                Repos.UsersRepository repo = new Repos.UsersRepository();
                repo.ConnectionString = this.connectionString;
                
                
                result = repo.ListUsers
                                (
                                    portalId,
                                    ResultsPerPage,
                                    CurrentPage,
        ...
        /// <returns></returns>
        public DotNetNuke.Entities.Users.UserInfo GetUser(int userId, int portalId)
        {
        ...
        public void DeleteUnauthorizedUsers(int portalId)
        {
        ...
        public void RemoveDeletedUsers(int portalId)
        {
        ...
        public Utils.UpdateUserResponse UpdateUser(UserEntity user, int portalId)
        {

            Utils.UpdateUserResponse updateUserResult = new Utils.UpdateUserResponse();
            ...
            try
            {
                ...
                else
                {
                    ...
                    //Membership
                    v_DNN_UserInfo.Membership.Password = "password123";  //user.Password;
        ...
        public void ChangeAuthorizedStatus(int userId, int portalId, string mode)
        {
        ...
        public void ChangeDeleteStatus(int userId, int portalId, string mode)
        {
        ...
        public void SendPasswordResetLink(int portalId, int userId, DotNetNuke.Entities.Portals.PortalSettings portalSettings)
        {
        ...
        {
            get { return System.Configuration.ConfigurationManager.ConnectionStrings["SiteSqlServer"].ConnectionString; }
        }
