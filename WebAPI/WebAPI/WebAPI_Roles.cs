    ...
    public class RolesController : DnnApiController
    {
        ...
        public HttpResponseMessage RolesList()
        {
            ...
            try
            {
                ...
                List<DotNetNuke.Security.Roles.RoleInfo> roleList = Business.Controllers.DNN_Roles.ListPortalRoles(portalId);
        ...
        public HttpResponseMessage RolesAddRemove(int userid, string role, string mode)
        {
            ...
            try
            {
                ...
                //Getting portal roles for the current portal
                Business.Controllers.DNN_Roles.AddRemoveUserRole(portalId, userid, role, mode, this.PortalSettings);
